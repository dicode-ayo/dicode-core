...
test.describe('WebUI dashboard — Navigation', () => {
  ...
  // (webui.nav.label: "Auth Providers"); dc-nav renders it as a plain
  // root-relative <a href="/hooks/auth-providers"> sibling of the static
  // links, which is a full page navigation (app.js's click interceptor
  // leaves root-relative hrefs alone) into that task's own webhook-served SPA.
