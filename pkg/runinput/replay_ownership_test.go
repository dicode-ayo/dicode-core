...
func (stubFetcher) Fetch(_ context.Context, _, _ string, _ int64) (Persisted, error) {
	return Persisted{Source: "stub"}, nil
}
...
func TestReplay_OwnershipAllowsSelfTask(t *testing.T) {
	...
	r := &Replayer{runs: reg, store: stubFetcher{}, runner: &fakeReplayRunner{}}
