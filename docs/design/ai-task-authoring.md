...
- **`dicode-buildin/ai-agent-core/chat.ts`** — the shared turn envelope extracted from the
...
| 2 | **Skill-truth fix** — real MCP tool surface in the shared `.md`s | `dicode-buildin/skills/` |
