...
# Also works on a daemon already running in the foreground, which
# hands over to a detached replacement — as does Ctrl-\ in its own terminal.
dicode daemon --detach
